...
extension DeveloperToolsSupport.ImageResource {
    ...
    /// The "JuiceMenuBarIcon" asset catalog image resource.
    static let juiceMenuBarIcon = DeveloperToolsSupport.ImageResource(name: "JuiceMenuBarIcon", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "JuiceMenuBarIcon" asset catalog image.
    static var juiceMenuBarIcon: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .juiceMenuBarIcon)
#else
        .init()
#endif
    }
...
extension UIKit.UIImage {
    ...
    /// The "JuiceMenuBarIcon" asset catalog image.
    static var juiceMenuBarIcon: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .juiceMenuBarIcon)
#else
        .init()
